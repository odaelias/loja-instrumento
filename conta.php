...
<body>
    ...
    <main>
        ...
        <form action="./php/edit.php" method="post">
            ...
            <input type="text" name="uf" id="txt-uf" value="<?=$usuario['usr_uf']?>" minlength="2" maxlength="2">

            <label for="txt-cidade">Cidade</label>
            <input type="text" name="cidade" id="txt-cidade" value="<?=$usuario['usr_cidade']?>" minlength="2" maxlength="50">

            <label for="txt-bairro">Bairro</label>
            <input type="text" name="bairro" id="txt-bairro" value="<?=$usuario['usr_bairro']?>" minlength="2" maxlength="50">

            <label for="txt-endereco">Endereço</label>
            <input type="text" name="endereco" id="txt-endereco" value="<?=$usuario['usr_endereco']?>" minlength="2" maxlength="50">

            <label for="nmb-numero">Número</label>
            <input type="number" name="numero" id="nmb-numero" value="<?=$usuario['usr_numero']?>" min="1" max="9999">
